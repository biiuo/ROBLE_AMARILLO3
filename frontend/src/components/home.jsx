...
import { apiGetCourses, apiGetMyCourses, apiEnrollCourse } from "../api/cursos";
...
export default function Home({
  ...
  const [enrolledCoursesHome, setEnrolledCoursesHome] = useState(new Set());

  // Cargar cursos destacados
  useEffect(() => {
    loadFeaturedCourses();
  }, []);
  // Agrega esta función en tu componente Home
...
// En el componente Home, agrega estos estados y funciones:


// Cargar cursos inscritos cuando el usuario cambie
useEffect(() => {
  if (user) {
    loadEnrolledCoursesHome();
  }
}, [user]);

const loadEnrolledCoursesHome = async () => {
  try {
    const result = await apiGetMyCourses();
    if (result.ok) {
      const enrolledIds = result.data?.courses?.map(course => course._id) || [];
      setEnrolledCoursesHome(new Set(enrolledIds));
    }
  } catch (error) {
    console.error("Error loading enrolled courses in home:", error);
  }
};

const isCourseEnrolledHome = (courseId) => {
  return enrolledCoursesHome.has(courseId);
};

const handleEnrollFromHome = async (courseId) => {
  try {
    const result = await apiEnrollCourse(courseId);
    if (result.ok) {
      setEnrolledCoursesHome(prev => new Set([...prev, courseId]));
  ...
  useEffect(() => {
    console.log("🎯 Datos crudos del backend:", featuredCourses);
  }, [featuredCourses]);
          ...
          <div key={course._id} className="bg-gray-50 rounded-xl shadow-sm border overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="h-48 relative overflow-hidden bg-gray-200">
              ...
              <div className={`absolute inset-0 flex items-center justify-center ${
                course.image ? 'bg-black bg-opacity-20' : 'bg-gradient-to-br from-yellow-400 to-yellow-500'
              }`}>
                {!course.image && (
            ...
            <div className="p-6">
              ...
              {/* AQUÍ VA EL BOTÓN QUE ME MOSTRASTE */}
              <button
                onClick={() => {
                  if (!user) {
                    onOpenRegister();
                  } else if (isCourseEnrolledHome(course._id)) {
                    onNavigate("my-courses");
                  } else {
                    handleEnrollFromHome(course._id);
                  }
                }}
                className={`w-full py-3 rounded-lg font-medium transition-colors ${
                  user && isCourseEnrolledHome(course._id)
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                ...
                <p className="text-gray-600">
                  Aprende con contenido actualizado y profesionales expertos
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                ...
                <p className="text-gray-600">
                  Obtén certificados que validen tus conocimientos
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Aprende cuando quieras, desde cualquier dispositivo
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Recibe ayuda de instructores y la comunidad
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 bg-gray-800 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Regístrate ahora y accede a todos nuestros cursos, certificados y
              una comunidad de aprendizaje activa
            </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-gray-400 mb-4">
                  Plataforma educativa de excelencia para tu crecimiento
                  profesional. Aprende las habilidades más demandadas del
                  mercado.
                </p>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center">
              <p className="text-gray-400">
                © 2024 Roble Amarillo Fundamentals. Todos los derechos
                reservados.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border text-center">
            ...
            <p className="text-gray-600 text-sm mb-4">
              Descubre nuevos cursos para tu crecimiento
            </p>
            <button
              onClick={() => onNavigate("catalog")}
